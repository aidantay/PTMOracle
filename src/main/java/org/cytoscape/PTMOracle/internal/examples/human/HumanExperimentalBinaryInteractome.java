...
/**
 * HumanExperimentalInteractome represents the experimentally derived human PPI network from Rolland et al. (2014).
 * @author aidan
 */
public class HumanExperimentalBinaryInteractome extends AbstractExampleNetwork {
	
	private static final String HUMAN_INTERACTOME_NAME  = "Human Experimental Binary Interactome"; 
	private static final String HUMAN_INTERACTOME_EDGES = "human_experimental_binary_interactome_edge_table.txt";
	private static final String HUMAN_INTERACTOME_NODES = "human_experimental_binary_interactome_node_table.txt";
	private static final int HUMAN_INTERACTOME_COLUMNS  = 4;
	
	public HumanExperimentalBinaryInteractome() {
		super();
	}
