...
/**
 * HumanExperimentalInteractome represents the experimentally derived human PPI network from Huttlin et al. (2017).
 * @author aidan
 */
public class HumanExperimentalCocomplexInteractome extends AbstractExampleNetwork {
	
	private static final String HUMAN_INTERACTOME_NAME  = "Human Experimental Co-complex Interactome"; 
	private static final String HUMAN_INTERACTOME_EDGES = "human_experimental_cocomplex_interactome_edge_table.txt";
	private static final String HUMAN_INTERACTOME_NODES = "human_experimental_cocomplex_interactome_node_table.txt";
	private static final int HUMAN_INTERACTOME_COLUMNS  = 4;
	
	public HumanExperimentalCocomplexInteractome() {
		super();
	}
