...
/**
 * Task for creating the literature-curated human PPI network.
 * @author aidan
 */
public class HumanLiteratureInteractomeTask extends AbstractExampleNetworkTask {

	public HumanLiteratureInteractomeTask(CyNetworkManager netMgr,
