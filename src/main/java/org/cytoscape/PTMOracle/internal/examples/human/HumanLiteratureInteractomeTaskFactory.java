...
/**
 * Task factory for creating the literature-curated human PPI network.
 * @author aidan
 */
public class HumanLiteratureInteractomeTaskFactory extends AbstractExampleNetworkTaskFactory {

	public HumanLiteratureInteractomeTaskFactory(CyNetworkManager netMgr,
	...
	public ExampleNetwork createExampleNetwork() {
		return new HumanLiteratureInteractome();
	}
	
	public Task createTask(ExampleNetwork exampleNetwork) {
		return new HumanLiteratureInteractomeTask(getNetMgr(), getNamingUtil(), getCnf(), getViewMgr(), getCnvf(), getVisMapMgr(), exampleNetwork);		
	}
}
