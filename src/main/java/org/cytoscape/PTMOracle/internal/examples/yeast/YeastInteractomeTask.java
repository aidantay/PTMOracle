...
/**
 * Task for creating the yeast PPI network.
 * @author aidan
 */
public class YeastInteractomeTask extends AbstractExampleNetworkTask {

	public YeastInteractomeTask(CyNetworkManager netMgr,
